...
- (void)insertBookmarkWithTitle:(NSString *)bookmarkTitle {
    ...
    if (bookmarkTitle.length == 0) {
        ...
        UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"" message:@"Bookmark title should not be empty" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil];
